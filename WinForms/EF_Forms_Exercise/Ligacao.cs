    ...
    public class Ligacao : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Maquina>()
                ...
                .OnDelete(DeleteBehavior.SetNull); // Ao excluir o usuário, as máquinas ficam sem usuário
            ...
            modelBuilder.Entity<Software>()
                ...
                .OnDelete(DeleteBehavior.Cascade); // Ao excluir a máquina, os softwares são excluídos
        }
    }
}
